...
function Navbar({ onToggleSidebar }) {
  ...
  `}
        ...
        <div className="relative w-150 hidden md:block">
          <Search className="absolute right-0 top-1/2 bg-[#252525] rounded-r-full -translate-y-1/2 text-gray-400 w-16 h-10 cursor-pointer" />
      ...
      {mobileSearchOpen && (
        <div className="fixed top-0 left-0 w-full h-16 bg-black flex items-center justify-between px-4 z-50">
          ...
          <Search className="text-white w-7 h-7 cursor-pointer" />
        </div>
      )}
    </>
  );
