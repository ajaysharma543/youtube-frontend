...
const Sidebar = ({ collapse,setMobileOpen,mobileOpen,isTablet }) => {
 ...
 const navItems = [
  ...
  { name: "Playlist", icon: <PlayCircleIcon className="w-5 h-5" />, path: "/Playlist" },
  { name: "your videos", icon: <Video className="w-5 h-5" />, path: "/content" },
  { name: "watch later", icon: <Watch className="w-5 h-5" />, path: "/watchlater" },
  { name: "Liked-videos", icon: <ThumbsUp className="w-5 h-5" />, path: "/liked" },
  { name: "Subscription", icon: <Users className="w-5 h-5" />, path: "/Subscription" },
